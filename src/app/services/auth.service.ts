...
export class AuthService {
  ...
  user$ = new BehaviorSubject<User | null>(null); // BehaviorSubject es un tipo de Subject que siempre emite el último valor que se le ha pasado o el valor por defecto.
